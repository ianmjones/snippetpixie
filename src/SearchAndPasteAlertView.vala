...
public class SnippetPixie.SearchAndPasteAlertView : Gtk.Grid {
    /**
    ...
    /**
     * Makes new SearchAndPasteAlertView
     *
     * @param title the first line of text
     * @param description the second line of text
     * @param icon_name the icon to be shown
     */
    public SearchAndPasteAlertView (string title, string description, string icon_name) {
